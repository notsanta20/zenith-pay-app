...
export default function Profile() {
  return (
    <SidebarInset className="px-5 py-5 flex flex-col min-w-0 hover:cursor-default">
      ...
      <main className="flex-auto flex flex-col pt-25 gap-30">
        <div className="flex flex-col gap-5 min-w-[350px] w-full md:min-w-[500px] md:max-w-[700px] md:mx-auto overflow-hidden">
          <ProfileHeader />
          <ProfileContent />
        </div>
      </main>
